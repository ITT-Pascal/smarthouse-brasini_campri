...
namespace BlaisePascal.SmartHouse.Domain.UnitTest.LuminousDevices
{
    public class TwoLampDeviceTest
    {
        ...
        public void IncreaseBothBrightness_WhenCalled_IncreasesBrightnessOfBothLamps()
        {
            ...
            // Assert
            Assert.Equal(BrightnessRecord.Create(2), lamp1.Brightness);
            Assert.Equal(BrightnessRecord.Create(2), lamp2.Brightness);
        }
        ...
        public void DecreaseBothBrightness_WhenCalled_DecreasesBrightnessOfBothLamps()
        {
            ...
            // Assert
            Assert.Equal(BrightnessRecord.Create(1), lamp1.Brightness);
            Assert.Equal(BrightnessRecord.Create(1), lamp2.Brightness);
        }
        ...
        public void IncreaseBothBrightness_AtMaxBrightness_DoesNotExceedMax()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                // Assert
            Assert.Equal(BrightnessRecord.Create(10), lamp1.Brightness);
            Assert.Equal(BrightnessRecord.Create(10), lamp2.Brightness);
        }
        ...
        public void ChangeOneBrightness_WhenParameterIs1_ChangesLamp1Brightness()
        {
            ...
            // Assert
            Assert.Equal(BrightnessRecord.Create(4), lamp1.Brightness);
        }
        ...
        public void ChangeOneBrightness_WhenParameterIs2_ChangesLamp2Brightness()
        {
            ...
            // Assert
            Assert.Equal(BrightnessRecord.Create(6), lamp2.Brightness);
        }
